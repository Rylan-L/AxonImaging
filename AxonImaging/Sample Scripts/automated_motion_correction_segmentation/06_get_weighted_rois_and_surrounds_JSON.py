...
pt.save_figure_without_borders(f_c_bg, os.path.join(save_folder, prefix+'_2P_ROIs_with_background.png'), dpi=300)
pt.save_figure_without_borders(f_c_nbg, os.path.join(save_folder, prefix+'_2P_ROIs_without_background.png'), dpi=300)
pt.save_figure_without_borders(f_s_nbg, os.path.join(save_folder,prefix+ '_2P_ROI_surrounds_background.png'), dpi=300)
